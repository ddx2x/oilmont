...
func init() {
	k8s.ShardingResourceRegistry.Register("services", k8s.GVR{Group: "", Version: "v1", Resource: "services"})
}

func (k *KesServer) listServices(g *gin.Context) {
	...
	gvr, err := k8s.ShardingResourceRegistry.GetGVR("services")
	if err != nil {
