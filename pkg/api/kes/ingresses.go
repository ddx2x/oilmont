...
func init() {
	k8s.ShardingResourceRegistry.Register("ingresses", k8s.GVR{Group: "networking.k8s.io", Version: "v1", Resource: "ingresses"})
}

func (k *KesServer) listIngresses(g *gin.Context) {
	...
	gvr, err := k8s.ShardingResourceRegistry.GetGVR("ingresses")
	if err != nil {
