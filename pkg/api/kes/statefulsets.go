...
func init() {
	k8s.ShardingResourceRegistry.Register("statefulsets", k8s.GVR{Group: "apps", Version: "v1", Resource: "statefulsets"})
}

func (k *KesServer) listStatefulSets(g *gin.Context) {
	...
	gvr, err := k8s.ShardingResourceRegistry.GetGVR("statefulsets")
	if err != nil {
