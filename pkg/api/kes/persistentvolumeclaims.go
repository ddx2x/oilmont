...
func init() {
	k8s.ShardingResourceRegistry.Register("persistentvolumeclaims", k8s.GVR{Group: "", Version: "v1", Resource: "persistentvolumeclaims"})
}

func (k *KesServer) listPersistentVolumeClaims(g *gin.Context) {
	...
	gvr, err := k8s.ShardingResourceRegistry.GetGVR("persistentvolumeclaims")
	if err != nil {
