...
func init() {
	k8s.ShardingResourceRegistry.Register("configmaps", k8s.GVR{Group: "", Version: "v1", Resource: "configmaps"})
}

func (k *KesServer) listConfigMaps(g *gin.Context) {
	...
	gvr, err := k8s.ShardingResourceRegistry.GetGVR("configmaps")
	if err != nil {
