...
func init() {
	k8s.ShardingResourceRegistry.Register("persistentvolumes", k8s.GVR{Group: "", Version: "v1", Resource: "persistentvolumes"})
}

func (k *KesServer) listPersistentVolume(g *gin.Context) {
	...
	gvr, err := k8s.ShardingResourceRegistry.GetGVR("persistentvolumes")
	if err != nil {
