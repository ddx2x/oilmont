...
func init() {
	k8s.ShardingResourceRegistry.Register("storageclasses", k8s.GVR{Group: "storage.k8s.io", Version: "v1", Resource: "storageclasses"})
}

func (k *KesServer) listStorageClasses(g *gin.Context) {
	...
	gvr, err := k8s.ShardingResourceRegistry.GetGVR("storageclasses")
	if err != nil {
